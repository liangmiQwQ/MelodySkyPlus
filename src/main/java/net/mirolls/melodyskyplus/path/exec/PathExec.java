...
public class PathExec {
  ...
  public void onTick(EventTick event) {
    ...
    if (path != null && !path.isEmpty()) {
      ...
      // 移动玩家视角
      mc.thePlayer.rotationPitch = RotationUtil.smoothRotation(mc.thePlayer.rotationPitch, node.getNextRotation().getPitch(), 1);
      mc.thePlayer.rotationYaw = RotationUtil.smoothRotation(mc.thePlayer.rotationYaw, node.getNextRotation().getYaw(), 120);
