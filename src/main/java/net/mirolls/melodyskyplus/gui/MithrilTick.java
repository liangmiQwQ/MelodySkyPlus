...
public class MithrilTick extends HUDElement {
  public MithrilTick() {
...
//    CFontRenderer font = FontLoaders.NMSL20;  /*(2.14.5及之前版本)*/
    ...
    float length = font.getStringWidth("MithrilTick: " + MelodySkyPlus.nukerTicks.getCurrentTicks()) + 4;
    RenderUtil.rect(this.x, this.y,
        (this.x + length),
        (this.y + font.getHeight() + 5),
        2.0F, c2);

    font.drawString(
        "MithrilTick: " + MelodySkyPlus.nukerTicks.getCurrentTicks(),
        (this.x + 2F), (this.y + 2.5F), -1
    );
